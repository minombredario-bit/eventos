...
class AuthController extends AbstractController
{
    ...
    #[Route('/api/me/cambiar-password', name: 'api_me_cambiar_password', methods: ['POST'])]
    public function cambiarPassword(Request $request, #[CurrentUser] ?Usuario $user): JsonResponse
    {
        if (null === $user) {
            return new JsonResponse([
                'message' => 'No autenticado'
