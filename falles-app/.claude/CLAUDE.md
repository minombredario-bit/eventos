...
Aplicación PWA para gestión de comidas y eventos de entidades festivas (fallas, comparsas, peñas, hermandades…). Stack: **Symfony 7.3 + API Platform 3** en backend, **Angular 18 + PWA** en frontend.
...
- los mensajes de commit en inglés, imperativo: `Add censo import endpoint`
