...
Write-Host '[dev-start] Reparando permisos de Symfony var/ en el contenedor PHP'
Invoke-Compose @('exec', '-T', '--user', 'root', 'php', 'sh', '-lc', 'cd /var/www/html && ./scripts/fix_var_permissions.sh')
