...
#[ORM\Table(
    ...
    uniqueConstraints: [
        new ORM\UniqueConstraint(name: 'uniq_inscripcion_linea_usuario_actividad', columns: ['usuario_id', 'actividad_id']),
        new ORM\UniqueConstraint(name: 'uniq_inscripcion_linea_invitado_actividad', columns: ['invitado_id', 'actividad_id']),
    ],
)]
#[ApiResource(
    operations: [
...
class InscripcionLinea
{
    ...
    public function crearSnapshot(): void
    {
        ...
        $this->nombreActividadSnapshot  = $this->actividad->getNombre();
        $this->franjaComidaSnapshot = $this->actividad->getFranjaComida()->value;
        $this->esDePagoSnapshot    = $this->actividad->isEsDePago();
    }
    ...
    public function getActividad(): ActividadEvento
    {
    ...
    #[SerializedName('actividad')]
    public function setActividad(ActividadEvento $actividad): static
    {
    ...
    {
        return $this->nombreActividadSnapshot;
    }
