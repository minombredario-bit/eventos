...
class UsuarioReconocimiento
{
    ...
    #[ORM\ManyToOne(targetEntity: Usuario::class, inversedBy: 'usuarioReconocimientos')]
    ...
    public function getReconocimiento(): Reconocimiento
    {
        return $this->reconocimiento;
    }

    public function setReconocimiento(Reconocimiento $reconocimiento): static
    {
    ...
    public function getTemporadaCodigo(): ?string
    {
        return $this->temporadaCodigo;
    }

    public function setTemporadaCodigo(?string $temporadaCodigo): static
    {
        $this->temporadaCodigo = $temporadaCodigo;

        return $this;
    }

    public function getFechaConcesion(): ?\DateTimeImmutable
    {
        return $this->fechaConcesion;
    }

    public function setFechaConcesion(?\DateTimeImmutable $fechaConcesion): static
    {
