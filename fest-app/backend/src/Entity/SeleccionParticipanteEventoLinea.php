...
#[ORM\Table(
    ...
    indexes: [
        ...
        new ORM\Index(name: 'idx_sel_part_evento_actividad', columns: ['actividad_id']),
    ...
    uniqueConstraints: [
        new ORM\UniqueConstraint(name: 'uniq_sel_part_evento_actividad_usuario', columns: ['evento_id', 'actividad_id', 'usuario_id']),
        new ORM\UniqueConstraint(name: 'uniq_sel_part_evento_actividad_invitado', columns: ['evento_id', 'actividad_id', 'invitado_id']),
    ]
)]
...
class SeleccionParticipanteEventoLinea
{
    ...
    #[ORM\JoinColumn(name: 'actividad_id', nullable: false, onDelete: 'RESTRICT')]
    #[Assert\NotNull]
