 ...
 */
final class Version20260418021151 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE actividad_evento (id CHAR(36) NOT NULL, nombre VARCHAR(255) NOT NULL, descripcion LONGTEXT DEFAULT NULL, tipo_actividad VARCHAR(50) NOT NULL, franja_comida VARCHAR(50) NOT NULL, compatibilidad_persona VARCHAR(50) NOT NULL, es_de_pago TINYINT NOT NULL, precio_base NUMERIC(8, 2) NOT NULL, precio_adulto_interno NUMERIC(8, 2) DEFAULT NULL, precio_adulto_externo NUMERIC(8, 2) DEFAULT NULL, precio_infantil NUMERIC(8, 2) DEFAULT NULL, unidades_maximas INT DEFAULT NULL, orden_visualizacion INT NOT NULL, activo TINYINT NOT NULL, confirmacion_automatica TINYINT NOT NULL, observaciones_internas LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, evento_id CHAR(36) NOT NULL, INDEX IDX_56F6B4CC87A5F842 (evento_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE cargo_master (id CHAR(36) NOT NULL, nombre VARCHAR(120) NOT NULL, codigo VARCHAR(100) DEFAULT NULL, descripcion LONGTEXT DEFAULT NULL, computa_como_directivo TINYINT DEFAULT 0 NOT NULL, es_representativo TINYINT DEFAULT 0 NOT NULL, es_infantil TINYINT DEFAULT 0 NOT NULL, infantil_especial TINYINT DEFAULT 0 NOT NULL, activo TINYINT DEFAULT 1 NOT NULL, orden_jerarquico SMALLINT DEFAULT 0 NOT NULL, anios_computables NUMERIC(6, 2) DEFAULT \'1.00\' NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE reconocimiento (id CHAR(36) NOT NULL, codigo VARCHAR(100) NOT NULL, nombre VARCHAR(150) NOT NULL, tipo VARCHAR(50) NOT NULL, orden SMALLINT NOT NULL, min_antiguedad NUMERIC(6, 2) DEFAULT NULL, min_antiguedad_directivo NUMERIC(6, 2) DEFAULT NULL, requiere_directivo TINYINT DEFAULT 0 NOT NULL, requiere_anterior TINYINT DEFAULT 0 NOT NULL, activo TINYINT DEFAULT 1 NOT NULL, entidad_id CHAR(36) NOT NULL, INDEX IDX_A19F47246CA204EF (entidad_id), UNIQUE INDEX uniq_reconocimiento_entidad_codigo (entidad_id, codigo), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE usuario_temporada_cargo (id CHAR(36) NOT NULL, principal TINYINT DEFAULT 0 NOT NULL, computa_antiguedad TINYINT DEFAULT 1 NOT NULL, computa_reconocimiento TINYINT DEFAULT 1 NOT NULL, anios_extra_aplicados NUMERIC(6, 2) DEFAULT \'0.00\' NOT NULL, tipo_persona VARCHAR(20) NOT NULL, orden SMALLINT DEFAULT 0 NOT NULL, observaciones LONGTEXT DEFAULT NULL, usuario_id CHAR(36) NOT NULL, temporada_id CHAR(36) NOT NULL, cargo_id CHAR(36) NOT NULL, INDEX IDX_D850141BDB38439E (usuario_id), INDEX IDX_D850141B6E1CF8A8 (temporada_id), INDEX IDX_D850141B813AC380 (cargo_id), UNIQUE INDEX uniq_usuario_temporada_cargo (usuario_id, temporada_id, cargo_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('ALTER TABLE usuario_temporada_cargo ADD CONSTRAINT FK_D850141B813AC380 FOREIGN KEY (cargo_id) REFERENCES cargo (id) ON DELETE CASCADE');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE usuario_temporada_cargo DROP FOREIGN KEY FK_D850141B813AC380');
