 ...
 */
final class Version20260409133651 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cargo (id CHAR(36) NOT NULL, nombre VARCHAR(120) NOT NULL, descripcion LONGTEXT DEFAULT NULL, multiplicador NUMERIC(8, 2) NOT NULL, entidad_id CHAR(36) NOT NULL, INDEX IDX_3BEE57716CA204EF (entidad_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE usuario (id CHAR(36) NOT NULL, nombre VARCHAR(100) NOT NULL, apellidos VARCHAR(150) NOT NULL, nombre_completo VARCHAR(255) NOT NULL, email VARCHAR(180) NOT NULL, telefono VARCHAR(50) DEFAULT NULL, password VARCHAR(255) NOT NULL, roles JSON NOT NULL, activo TINYINT NOT NULL, tipo_usuario_economico VARCHAR(50) NOT NULL, estado_validacion VARCHAR(50) NOT NULL, es_censado_interno TINYINT NOT NULL, codigo_registro_usado VARCHAR(50) DEFAULT NULL, censado_via VARCHAR(50) DEFAULT NULL, antiguedad SMALLINT DEFAULT NULL, antiguedad_real SMALLINT DEFAULT NULL, forma_pago_preferida VARCHAR(50) DEFAULT NULL, debe_cambiar_password TINYINT NOT NULL, password_actualizada_at DATETIME DEFAULT NULL, fecha_solicitud_alta DATETIME DEFAULT NULL, fecha_alta_censo DATETIME DEFAULT NULL, fecha_baja_censo DATETIME DEFAULT NULL, motivo_baja_censo LONGTEXT DEFAULT NULL, fecha_validacion DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, fecha_nacimiento DATE DEFAULT NULL, entidad_id CHAR(36) NOT NULL, validado_por_id CHAR(36) DEFAULT NULL, UNIQUE INDEX UNIQ_2265B05DE7927C74 (email), INDEX IDX_2265B05D6CA204EF (entidad_id), INDEX IDX_2265B05D8892BEA7 (validado_por_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE usuario_cargo (usuario_id CHAR(36) NOT NULL, cargo_id CHAR(36) NOT NULL, INDEX IDX_26303D6FDB38439E (usuario_id), INDEX IDX_26303D6F813AC380 (cargo_id), PRIMARY KEY (usuario_id, cargo_id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('ALTER TABLE actividad_evento ADD CONSTRAINT FK_56F6B4CC87A5F842 FOREIGN KEY (evento_id) REFERENCES evento (id)');
        $this->addSql('ALTER TABLE cargo ADD CONSTRAINT FK_3BEE57716CA204EF FOREIGN KEY (entidad_id) REFERENCES entidad (id)');
        ...
        $this->addSql('ALTER TABLE usuario_cargo ADD CONSTRAINT FK_26303D6FDB38439E FOREIGN KEY (usuario_id) REFERENCES usuario (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE usuario_cargo ADD CONSTRAINT FK_26303D6F813AC380 FOREIGN KEY (cargo_id) REFERENCES cargo (id) ON DELETE CASCADE');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE usuario_cargo DROP FOREIGN KEY FK_26303D6FDB38439E');
        $this->addSql('ALTER TABLE usuario_cargo DROP FOREIGN KEY FK_26303D6F813AC380');
