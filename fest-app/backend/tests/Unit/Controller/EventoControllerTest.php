...
class EventoControllerTest extends TestCase
{
    public function testInscribirmeAcceptsActividadPayloadAndReturnsDualAliases(): void
    {
        ...
        $linea = $this->createConfiguredMock(InscripcionLinea::class, [
            ...
            'getActividad' => $this->createConfiguredMock(ActividadEvento::class, ['getId' => 'act-1']),
        ...
        $inscripcionService
            ...
            ->with(
                $evento,
                $usuario,
                $this->callback(static fn(array $personas): bool => ($personas[0]['actividad'] ?? null) === '/api/actividad_eventos/act-1'),
            )
        ...
        $request = Request::create('/api/eventos/evento-1/inscribirme', 'POST', [], [], [], [], json_encode([
            'personas' => [[
                ...
                'actividad' => '/api/actividad_eventos/act-1',
            ]],
        ],
            \JSON_THROW_ON_ERROR));
    ...
    public function testInscribirmeAcceptsLegacyActividadPayload(): void
    {
        $entidad = $this->createConfiguredMock(\App\Entity\Entidad::class, ['getId' => 'entidad-1']);
        ...
        $inscripcionService
            ...
            ->with(
                $evento,
                $usuario,
                $this->callback(static fn(array $personas): bool => ($personas[0]['actividad'] ?? null) === '/api/actividad_eventos/legacy-1'),
            )
            ->willReturn($inscripcion);
        ...
        $request = Request::create('/api/eventos/evento-1/inscribirme', 'POST', [], [], [], [], json_encode([
            'personas' => [[
                'usuario' => '/api/usuarios/user-1',
                'actividad' => '/api/actividad_eventos/legacy-1',
            ]],
        ], \JSON_THROW_ON_ERROR));
    ...
    {
        $evento = $this->createConfiguredMock(\App\Entity\Evento::class, [
            'getActividades' => new ArrayCollection([]),
        ]);
